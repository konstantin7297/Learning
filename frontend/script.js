...
import {myValue} from './script.js' // Импорт файла. Позволяет загрузить переменную из другого файла. При импорте по-умолчанию '{}' не нужны.
export let myValue = 1 // Экспорт файла. Позволяет выгрузить эту переменную в другой файл. По-умолчанию: 'export default myValue' - будет выгружать по-умолчанию.
