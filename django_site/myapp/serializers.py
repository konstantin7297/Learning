...
class ProductSerializer(serializers.ModelSerializer):  # serializers.Serializer для данных не от записей таблиц. При валидации юзать: 'is_valid(raise_exception=True)'. # noqa
