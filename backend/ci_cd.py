class Test:
    ...
    def info():  # noqa
        ...
        django_pytest = {  # Установка: pip install pytest pytest-django # noqa
            "pytest.ini": """
                [pytest]
            ...
            """,  # Файл стандартный с тестами.
            "conftest.py": "",  # Файл рядом с тестами.
        }  # Тестирование с помощью 'pytest' в Django. В общем структурно тесты и фикстуры можно вынести в отдельную папку, работать почти как обычно. # noqa
        return info, commands, scope, tdd, bdd, test_types, django_pytest
    ...
    @staticmethod  # Пример тестов на 'Unittest'.
    def unittest():  # noqa
    ...
    @staticmethod  # Пример тестов на 'Doctests'.
    def doctests():
        """ Тут описан пример тестирования прямо в документации. Такой способ встроен в Python. """
        def multiply(a, b):
            """
